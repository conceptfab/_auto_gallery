...
const LoginPage: React.FC = () => {
  ...
  const handleEmailSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (response.ok) {
        setMessage('Wniosek został wysłany do administratora. Sprawdź swoją skrzynkę email po otrzymaniu zatwierdzenia.');
        setStep('code');
      } else {
        ...
        <div style={{
          ...
          {step === 'email' ? (
            <form onSubmit={handleEmailSubmit}>
              <h2 style={{ marginBottom: '20px', color: '#555' }}>Wprowadź swój email</h2>
          ...
          <div style={{
            ...
            <ol style={{ margin: '10px 0 0 20px', padding: 0 }}>
              ...
              <li>Administrator otrzyma powiadomienie i zatwierdzi Twój dostęp</li>
