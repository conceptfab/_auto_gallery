...
const ScanProgressBar: React.FC<{
  ...
  // Jeśli scheduler utknął (ostatni skan dawno temu) i nie jest aktywny – czerwony alert
  if (isStuck && !schedulerActive) {
    return (
      <div
        style={{
          marginTop: '12px',
      ...
      >
        ...
        >
          ...
          <div style={{ marginTop: '8px', fontWeight: 500 }}>
            Po wejściu w tę sekcję scheduler uruchamia się automatycznie –
            odśwież stronę za chwilę lub kliknij &quot;Skanuj zmiany&quot;, aby
            uruchomić skan od razu.
          </div>
        </div>
      </div>
    );
